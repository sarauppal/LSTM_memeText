# -*- coding: utf-8 -*-
"""
Created on Mon Oct 28 10:16:45 2019
...
def vectorized_data(data, item2id):
	return [[item2id[token] if token in item2id else item2id['UNK'] for token in eval(seq)] for seq, _ in data]

def pad_sequences(vectorized_seqs, seq_lengths):
    # create a zero matrix
    seq_lengths[seq_lengths>19]=19 #95th percentile length in our sequence
